...
The final document will add verified references to migrations, test cases, Swagger routes, dashboards, traces, and load results after their implementation phases. If an implemented detail differs from a decision above, the decision and its tests must be updated together before submission.
